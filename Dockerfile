...
ADD http://common-lisp.net/project/cmucl/downloads/release/20d/cmucl-20d-x86-linux.tar.bz2 /cmucl-20d-x86-linux.tar.bz2
RUN apt-get update && \
    apt-get install -y lib32z1 lib32ncurses5 lib32bz2-1.0 bzip2 && \
